...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <div><label>Branch:</label><input type="radio" name="branch" value="other"/>Other<input type="radio" name="branch" value="Cultural"/>Cultural<div style="margin-left:80px"><input type="radio" name="branch" value="Educational"/>Educational<input type="radio" name="branch" value="Novel"/>Novel and Poetry</div>
            </div>   
